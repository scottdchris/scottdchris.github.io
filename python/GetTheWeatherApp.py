...
Idea:
@GetTheWeather is a handle on twitter
When @GetTheWeather is mentioned in a geotagged tweet, the bot will
auto-respond with the following message (or something similar):

"Hey @user_handle,
it's currently xx degrees
high: yy*
low: zz*
Chance of Rain: rr%
No weather warnings in effect"

If the tweet is not geotagged, auto-respond:
"Hey, @user_handle, you forgot to add your location to your tweet!"
"""
...
APP_KEY		= 'r7zK98ZiKQs6obPrJ6dsng'
APP_SECRET	= 'S0LD2NmMpCwGATfDN74BEphgZikZyZ4Z6NkBou2M'
OAUTH_TOKEN = '1596294054-Lc0ZJD125XLWA3yj37xWzyUXbhgxMhoYGsqsDtm'
OAUTH_TOKEN_SECRET = '0Tub0IDo0cju7PvcYWGrDZ1p0j5XL1gjRRozpRmqYdM'
